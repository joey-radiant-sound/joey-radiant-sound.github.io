...
/**
 * A cappella sub-site hero. Phase 1E: gradient-backed type-first hero
 * with a longer specialization paragraph below the subhead. Parallax on
 * background imagery arrives in Phase 1G.
 */
